...
## 🔴 Problem
Your Vercel deployment shows "Login failed" because the **backend API is not deployed**. The frontend is trying to connect to `https://tool-inventory-14.preview.emergentagent.com` which is not accessible from Vercel.
